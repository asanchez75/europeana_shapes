...
#### Test Case: <a id="#agent_ok.xml_data" target="_blank" href="/shapes-edm/src/test/resources/etc/edm/data/external/agent_ok.xml">agent_ok.xml</a>
------
...
```
<a id="#agent_ok.xml_result">&nbsp;</a>_Below is the output generated by TopBraid SHACL validator in Turtle syntax:_

```
@prefix sh:    <http://www.w3.org/ns/shacl#> .
```

#### Test Case: <a id="#agent_closure.xml_data" target="_blank" href="/shapes-edm/src/test/resources/etc/edm/data/external/agent_closure.xml">agent_closure.xml</a>
------
...
```
<a id="#agent_closure.xml_result">&nbsp;</a>_Below is the output generated by TopBraid SHACL validator in Turtle syntax:_
...
#### Test Case: <a id="#agent_labels_multiple.xml_data" target="_blank" href="/shapes-edm/src/test/resources/etc/edm/data/external/agent_labels_multiple.xml">agent_labels_multiple.xml</a>
------
...
```
<a id="#agent_labels_multiple.xml_result">&nbsp;</a>_Below is the output generated by TopBraid SHACL validator in Turtle syntax:_
...
#### Test Case: <a id="#agent_labels_nolang.xml_data" target="_blank" href="/shapes-edm/src/test/resources/etc/edm/data/external/agent_labels_nolang.xml">agent_labels_nolang.xml</a>
------
...
```
<a id="#agent_labels_nolang.xml_result">&nbsp;</a>_Below is the output generated by TopBraid SHACL validator in Turtle syntax:_
...
#### Test Case: <a id="#agent_labels_redundant.xml_data" target="_blank" href="/shapes-edm/src/test/resources/etc/edm/data/external/agent_labels_redundant.xml">agent_labels_redundant.xml</a>
------
...
```
<a id="#agent_labels_redundant.xml_result">&nbsp;</a>_Below is the output generated by TopBraid SHACL validator in Turtle syntax:_
...
#### Test Case: <a id="#agent_prop_types.xml_data" target="_blank" href="/shapes-edm/src/test/resources/etc/edm/data/external/agent_prop_types.xml">agent_prop_types.xml</a>
------
...
```
<a id="#agent_prop_types.xml_result">&nbsp;</a>_Below is the output generated by TopBraid SHACL validator in Turtle syntax:_
