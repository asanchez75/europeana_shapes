...
This document contains test cases that target constraints that are specific to resources of type edm:Agent which are defined  within this [shape definition](/shapes-edm/doc/shapes/Agent.ttl)
