...
This document contains test cases that target constraints that are specific to resources of type ore:Aggregation and which are defined within this [shape definition](/shapes-edm/doc/shapes/Aggregation.md). The validation results were generated using [TopBraid SHACL](http://github.com/TopQuadrant/shacl) validator.  The following table shows the testcases that were run:
